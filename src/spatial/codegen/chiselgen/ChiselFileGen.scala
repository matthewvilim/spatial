  ...
  override def emitHeader(): Unit = {
    inAccel { // Guarantee prints for the following
      ...
      inGenn(out, "IOModule", ext) {
        ...
        emit ("  val argOutLoopbacks = Input(Vec(io_numArgOuts, UInt(64.W)))")
        emit ("}")
      ...
      inGenn(out, "BufferControlCxns", ext) {
        ...
        emitt("import fringe.utils._")
        emitt("import fringe.utils.implicits._")
      ...
      inGenn(out, "RootController", ext) {
        ...
        emitt("import fringe.templates._")
        emitt("import fringe.utils._")
        emitt("import fringe.utils.implicits._")
        emitt("import fringe.utils._")
        emitt("import fringe.templates.math._")
        emitt("import fringe.templates.counters._")
        emitt("import fringe.templates.memory._")
        emitt("import fringe.templates.retiming._")
  ...
  override def emitFooter(): Unit = {
    inAccel {// Guarantee prints for this section
      ...
      inGenn(out, "IOModule", ext) {
        ...
        open("val io = IO(new CustomAccelInterface(io_w, io_v, globals.LOAD_STREAMS, globals.STORE_STREAMS, globals.numAllocators, io_numArgIns, io_numArgOuts))")
  //         emit ("")
  //         emit ("// Stream IO")
